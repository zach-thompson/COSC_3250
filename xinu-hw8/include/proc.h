...
{
        int hasMessage;					// effectively a boolean
        message msgin;
        message msgout;
        qid_typ msgqueue;				// queue of messages
        spinlock_t core_com_lock;		// prevents duplicate messages from being sent/received
...
typedef struct pentry
{
	...
	struct pcb_msg msg_var;		/**< adding struct from above 				 */
} pcb;
